export const kunstenaars = [
  ...
  {
    naam: 'Carlos Caluwier',
    slug: 'carlos-caluwier',
    info: 'Keramiek en brons',
    afbeeldingen: [
      '/images/kunstenaars/carlos-caluwier/1.jpeg',
      '/images/kunstenaars/carlos-caluwier/2.jpeg',
      '/images/kunstenaars/carlos-caluwier/3.png',
      '/images/kunstenaars/carlos-caluwier/4.jpeg',
      '/images/kunstenaars/carlos-caluwier/5.png'
    ],
    wieIs: `Carlos Caluwier (°1956) maakt beelden onder de naam "Cccorpus". Vanuit zijn atelier in Zwevegem zoekt hij al jaren naar een zuivere, herkenbare beeldtaal met gestileerde vormen die naar het menselijk figuur reiken.`,
    kunstwerk: `Hij toont "Cccorpus". Gestileerde vormen reikend naar het menselijk figuur vormen de basis van zijn werk. Door kleuren, tekeningen en inkervingen krijgen de beelden hun huid. Carlos werkt met materialen zoals brons, keramiek, polyester en PLA, in formaten van 7 cm tot 200 cm.`,
    contactgegevens: `Watermolenstraat 3, 8550 Zwevegem
  carlos@caluwier.net
  www.caluwier.net`
  },
  {
  ...
  {
    naam: 'Daniël Dehulster',
    slug: 'daniël-dehulster',
    info: 'Plastiek',
    afbeeldingen: [
      '/images/kunstenaars/daniel-dehulster/1.jpg',
      '/images/kunstenaars/daniel-dehulster/2.jpg',
      '/images/kunstenaars/daniel-dehulster/3.jpg',
      '/images/kunstenaars/daniel-dehulster/4.jpg',
      '/images/kunstenaars/daniel-dehulster/5.jpg'
    ],
    wieIs: `Daniël Dehulster (°1956) begon als portretschilder in olieverf en won de eerste prijs in een nationale wedstrijd van het Vermeylenfonds. Later verschoof zijn focus naar beeldhouwen, zowel abstract als figuratief, in uiteenlopende materialen zoals klei, plaaster, cement, ijzer, was, keramiek en kunststof.`,
    kunstwerk: `Met "KUNST - STOF" hergebruikt hij plastiek en andere kunstmatige materialen die ooit bedoeld waren om lang mee te gaan, maar vaak als wegwerpverpakking eindigen. Door ze te verwerken tot kunst geeft hij die materialen opnieuw een lange levensduur.`,
    contactgegevens: `0479 19 14 69`
  },
  {
    naam: 'Daniel Joseph',
    slug: 'daniel-joseph',
    info: 'Arduin en metaal',
    afbeeldingen: [
      '/images/kunstenaars/daniel-joseph/1.jpg',
      '/images/kunstenaars/daniel-joseph/2.jpg'
    ],
    wieIs: `Daniel Joseph (°1957, Diksmuide) maakt werk op de grens tussen figuratief en abstract, in marmer, arduin en metaal.`,
    kunstwerk: `Hij toont "De verbintenis" en "De aanbidders": uitgerekte, rake figuren die ondanks hun verstilling een sterk aards contact behouden en elkaar ondersteunen.`,
    contactgegevens: `Danjos255@gmail.com
  0495 33 90 22`
  },
  {
    naam: 'David Smulders',
  ...
  },
  {
    ...
    slug: 'els-vermandere',
    info: 'Marmer',
    afbeeldingen: ['/images/kunstenaars/els-vermandere/1.jpeg'],
    wieIs: `Els Vermandere (°1967, Nieuwpoort) maakt beelden waarin tederheid, vrede, verlies en verbondenheid centraal staan. Haar werk vertrekt vanuit steen, maar zoekt steeds naar zachtheid, poëzie en wat mensen diep raakt.`,
    kunstwerk: `Ze toont "Je reist met ons mee" in marmer. Het werk verbeeldt hoe gemis en verdriet met ons meereizen; de omhelzing verzacht de hardheid van het maanwitte Carraramarmer waaruit het beeld ontstond.`,
    contactgegevens: `Vermandereels@gmail.com`
  },
  {
    naam: 'Erwin David',
    slug: 'erwin-david',
  ...
  {
    naam: 'Filiep Vandenberghe',
    slug: 'filiep-vandenberghe',
    info: 'Cortenstaal',
    afbeeldingen: [
      '/images/kunstenaars/filiep-vandenberghe/1.jpg',
      '/images/kunstenaars/filiep-vandenberghe/2.jpg',
      '/images/kunstenaars/filiep-vandenberghe/3.jpg',
      '/images/kunstenaars/filiep-vandenberghe/4.jpg',
      '/images/kunstenaars/filiep-vandenberghe/5.jpg',
    ],
    wieIs: `Filiep Vandenberghe (°1958, Kuurne) bouwde sinds 1993 expertise op als keramist. Vanuit een passie voor typografie groeide zijn werk verder naar kalligrafische kunst in cortenstaal, waarin elektrotechniek, metaalbewerking en kalligrafie samenkomen.`,
    kunstwerk: `Tijdens Kunst On(t)leed toont hij onder meer "Laad me met rust", "Jij bent goud waard", "Erger nog dan dood te zijn is niet te hebben bemind", "Het verwachte komt onverwacht op tijd" en "Laat de zon in je hart". Zijn werk vertrekt vanuit een schets op papier, wordt digitaal uitgewerkt en daarna in staal uitgelaserd. Op de tekstcirkel van Herman Leenders na zijn de getoonde werken letterclusters waarin letters op een harmonieuze manier met elkaar verbonden worden.`,
    contactgegevens: `Kruiskerkestraat 14 A
  8755 Wingene (Ruiselede)
  051 43 64 21
  0475 50 95 80
  info@filiepkeramiek.be
  ...
  },
  {
    ...
    info: 'Arduin',
    afbeeldingen: [
      '/images/kunstenaars/henk-korthuys/1.jpg',
      '/images/kunstenaars/henk-korthuys/2.jpg'
    ],
    wieIs: `Henk Korthuys (°1955) beeldhouwt in steen vanuit een passie om de ultieme vorm te vinden.`,
    kunstwerk: `Hij toont "Sign from the past I" en "Sign from the past II" in arduin. Beide werken maken deel uit van de reeks "Poorten" en verwijzen naar deuren die ooit in een poort zaten.`,
    contactgegevens: `info@henkkorthuys.be
  +32 497 64 75 87
  www.henkkorthuys.be`
  },
  {
    naam: 'John Vandelanotte',
    slug: 'john-vandelanotte',
    info: 'Klei, engobe en acryl',
    afbeeldingen: [
      '/images/kunstenaars/John-Vandelanotte/1.jpg',
      '/images/kunstenaars/John-Vandelanotte/2.jpg',
      '/images/kunstenaars/John-Vandelanotte/3.jpg',
      '/images/kunstenaars/John-Vandelanotte/4.jpg'
    ],
    wieIs: `John Vandelanotte (°1951) zoekt via klei naar expressie. Ideeën leven eerst een tijd in zijn hoofd en krijgen daarna vanuit zijn handen vorm; het maken zelf staat centraal.`,
    kunstwerk: `Hij toont onder meer een herinnering aan WaTuKu 2012 — met drie overlevende beelden van de 68 en een doek van Herman — en "Expressie in gezichten ... 6 brugwachters".`,
    contactgegevens: `johnvandelanotte1@gmail.com`
  },
  {
...
`
  },
  {
    ...
    contactgegevens: `leen.clybouw@hotmail.com`
  },
  {
...
Drie zwarte strepen die op het eerste zicht zeer eenvoudig lijken, maar een sterke aanwezigheid hebben, bepalen het centrum van dit werk. Ze raken elkaar niet, alsof ze grenzen bewaken. Tussen hen ontstaan doodles die als bruggen fungeren. Die fijne lijnen doorbreken de afstand en maken verbinding mogelijk waar de hoofdvormen dat niet doen. Het toont het belang van verbintenis in een wereld waarin grenzen mensen van elkaar scheiden.`,
  ...
  },
  {
    ...
    slug: 'luc-verbeke',
    info: 'Carrara marmer',
    afbeeldingen: ['/images/kunstenaars/luc-verbeke/1.jpeg'],
    wieIs: `Luc Verbeke (°1957, Kortrijk) is marmerbeeldhouwer. Hij vindt inspiratie in de natuur en mythologie en maakt werken die licht ogen, maar tegelijk de zwaarte van steen uitdagen.`,
    kunstwerk: `Hij toont "Walvisstaart" in Carrara marmer op een cortenstalen sokkel. Het werk werd speciaal gemaakt voor een tentoonstelling rond het thema water en kunst.`,
    contactgegevens: `marmerlucverbeke@gmail.com`
  },
  {
  ...
  },
  {
    ...
    info: 'Blauwe steen',
    afbeeldingen: [
      '/images/kunstenaars/manon-huguenin/1.jpg',
      '/images/kunstenaars/manon-huguenin/2.jpg',
      '/images/kunstenaars/manon-huguenin/3.jpg',
      '/images/kunstenaars/manon-huguenin/4.jpg'
    ],
    wieIs: `Manon Huguenin (°1956, La Chaux-de-Fonds, Zwitserland) probeert al haar hele leven vorm te geven aan emoties die woorden niet kunnen vertellen. Na theater, muziek en schilderkunst vond ze haar weg in het beeldhouwen in steen.`,
    kunstwerk: `Ze toont "Les ailes d'Esculape" in blauwe steen. Het beeld, genoemd naar Asclepius uit de Griekse mythologie, verbeeldt een gebed om genezing, gedragen door liefde en mededogen.`,
    contactgegevens: `Kennedylaan 23
  8420 De Haan`
  },
  {
...
patrick.vanderstichele@gmail.com`
  },
  {
    ...
    info: 'Brons',
    afbeeldingen: [
      '/images/kunstenaars/rita-craeynest/1.jpg',
